export default function Home() {
  return (
    <div className="flex justify-center bg-[url('/bg.jpeg')] bg-center bg-cover h-screen w-screen">
      <div className="flex flex-col sm:mx-0 min-h-fit mx-2 max-w-2xl">
        ...
        <a href="tg://resolve?domain=otbelivaniesupport" target="_top">
          <div className="flex text-white h-16 bg-[#61a8de] hover:bg-[#61a8de]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 rounded-3xl text-sm px-5 py-2.5 text-center items-center dark:focus:ring-[#3b5998]/55">
