      ...
      <div className="grid text-black bg-white rounded-3xl px-5 py-2.5 text-center">
        ...
        <div className="text-left space-y-4">
          <div class="flex flex-row space-x-2">
            <img src='http://taplink.st/p/b/6/9/a/29544012.jpg' alt='crest' width="65" />
            <div>
          ...
          <div className="flex flex-row space-x-2">
            <img src='http://taplink.st/p/5/b/c/a/29544054.jpg' alt='crest' width="65" height="65" />
            <div>
          ...
          <div className="flex flex-row space-x-2">
            <img src='http://taplink.st/p/4/5/0/5/29544882.jpg' alt='crest' width="65" height="65" />
            <div>
          ...
          <div className="flex flex-row space-x-2">
            <img src='http://taplink.st/p/9/e/4/c/29544939.png' alt='crest' width="65" height="65" />
            <div>
